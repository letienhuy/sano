                            ...
                            <div className="login-form">
                                <div className="form-container">
                                    ...
                                    <form ref={(el) => this.loginForm = el} onSubmit={this.handleSubmit}>
                                        <span style={{color: code ? "green" : "red"}}>{message}</span>
                                        <div className="input-container">
                                            <label htmlFor="username">Tài khoản</label>
                                            <input type="text" ref={(el) => this.nameInput = el} placeholder="Tài khoản hoặc email"/>
                                        </div>
                                        <div className="input-container">
                                            <label htmlFor="password">Mật khẩu</label>
                                            <input type="password" ref={(el) => this.passwordInput = el} placeholder="Mật khẩu"/>
                                        </div>
                                        ...
                                        <button className="btn login-btn">
                                            {loading ?  <BtnLoading loading={loading}/> : "Đăng nhập"}
                                        </button>
                                    </form>
                                </div>
                            </div>
